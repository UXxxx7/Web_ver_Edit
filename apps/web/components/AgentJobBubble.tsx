...
// "Share to Community" — the whole point of the community/actions.ts
// prepareCaptionFromJobAction chain: AI drafts a caption from the video's
// real transcript (not the edit_request or planned_edit.summary — see
// that action's own header for why), shown editable, never auto-posted.
// Self-contained state machine (idle -> loading -> editing/posting ->
// done) rather than lifting state up into AgentJobBubble itself — nothing
// above this needs to know a share happened.
